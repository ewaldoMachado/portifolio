...
export default function Menu(){
    ...
    return (
        <nav className="flex gap-6">
            ...
            <MenuItem href="/projeto/1" selecionado={caminho.startWith("/projeto")}>
                Projetos
            </MenuItem>
            <MenuItem href="https://api.whatsapp.com/send/?phone=5586999636503&text&type=phone" selecionado={false} novaAba={true}>
                Contato
            </MenuItem>
        </nav>
    )
